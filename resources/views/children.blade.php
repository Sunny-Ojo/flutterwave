...
@section('title', 'Children Payment page')
@section('content')

<div class="col-md-8 col-xs-12 mb-5">
<div class="card">
    <div class="card-header">
        <h3 class="text-center">Children/Teenagers</h3>

        <img src="/img/children.jpg" alt="" style="width:100%">
     </div>
     <div class="card-body">
        {!! Form::open(['action' => 'PaymentController@childrenPayment', 'method' => 'POST']) !!}
        ...
        <div class="form-group">
            {{ Form::label('number_of_children_or_teens', '  Number of Children/Teenagers') }}
            {{ Form::number('number_of_children_or_teens', '', ['class' => 'form-control', 'oninput' => 'calculate()', 'required', 'id' => 'number_of_children_or_teens'], ) }}
            @error('number_of_children_or_teens') <li class="text-danger">{{$message}}</li> @enderror

           </div>
           <div class="form-group">
               <h4 class="">Per Children/Teenager is <span class="text-danger">&#8358;200.</span> </h4>
